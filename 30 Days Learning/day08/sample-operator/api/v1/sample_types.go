...
type SampleStatus struct {
	...
	// conditions represent the current state of the Sample resource.
...
type Sample struct {
	...
	// spec defines the desired state of Sample
	// +required
	Spec SampleSpec `json:"spec"`

	// status defines the observed state of Sample
	// +optional
	Status SampleStatus `json:"status,omitempty,omitzero"`
}
